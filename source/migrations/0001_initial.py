# Generated by Django 5.1.1 on 2024-10-29 20:51
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.IntegerField()),
                ('updated', models.IntegerField()),
                ('consecutive_historic', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='consecutive', to='source.historicdaymodel')),
                ('nested_historic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='nested', to='source.historicdaymodel')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.IntegerField()),
                ('updated', models.IntegerField()),
                ('last_historic', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='source.historicdaymodel')),
                ('close_prophesy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='close', to='source.prophesymodel')),
                ('open_prophesy', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='open', to='source.prophesymodel')),
            ],
            options={
