# Generated by Django 5.1.1 on 2025-01-22 21:06
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.IntegerField()),
                ('analyze', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='source.analyze')),
                ('max_timeline', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='max_timeline', to='source.timeline')),
                ('min_timeline', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, related_name='min_timeline', to='source.timeline')),
            ],
            options={
                'db_table': 'forecasts',
