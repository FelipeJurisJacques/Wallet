# Generated by Django 5.1.1 on 2025-01-25 18:55
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('timeline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='source.timeline')),
            ],
            options={
                'db_table': 'prophesied',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('updated', models.IntegerField()),
                ('analyze', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='source.analyze')),
                ('max_timeline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='max_timeline', to='source.timeline')),
                ('min_timeline', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='min_timeline', to='source.timeline')),
            ],
            options={
                'db_table': 'forecasts',
            },
        ...
        migrations.AddField(
            model_name='analyze',
            name='timelines',
            field=models.ManyToManyField(db_index=True, to='source.timeline'),
        ),
    ]
